...
test('Can resolve 은/는, 이/가, 을/를, 과/와 아/야, 이어/여, 이*', () => {
...
test('Can resolve 은/는, 이/가, 을/를, 과/와 아/야, 이어/여, 이* against English', () => {
...
test('Can resolve 은/는, 이/가, 을/를, 과/와 아/야, 이어/여, 이* against numbers', () => {
...
test('Returns null if the given token string is unsupported or malformed', () => {
  expect(resolve('이더냐', '부자')).toEqual(null)
  expect(resolve('의', '사과')).toEqual(null)
})
